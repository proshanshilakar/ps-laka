    ...
    if(0==state)
{
    ...
    anime.timeline().add(
    {
        targets:nextClass+" .image",scale:[.85,1],
        translateX:["10%", 0],
        translateZ:0,
        easing:"easeOutCubic",
        duration:1500,
        ...
        function()
{
    ...
    imageBig={
        ...
        Barba.Pjax.preventCheck=function(evt,
            element)
{
...
{
    return PageTransitionCurtain}):$("#js-fullpage").length?(console.log("top"),
    Barba.Pjax.getTransition=function()
{
    return PageTransitionTop}):(console.log("under"),
    Barba.Pjax.getTransition=function()
{
        ...
        onEnter:function()
{
    ...
    Barba.Pjax.getTransition=function(){
    return PageTransitionTop}})},onEnterCompleted:function()
{
        ...
        namespace:"underlayer",onEnter:function()
{
    Barba.Pjax.getTransition=function()
    {
        return PageTransitionUnder},$(window).scroll(function()
{
    $(".js-scroll").each(function(i)
{
    $(window).scrollTop()+$(window).height()>$(this).offset().top&&$(this).addClass("in")})}),isSp&&$(".page-top").height($(window).height()),console.log(isSp)},onEnterCompleted:function()
{
    headerColor();
    anime.timeline(
    {
        duration:500,
        easing:"easeInOutCubic"}).add(
    {
        targets:".btn-wrap",
        translateY:["110%",0]}).add(
    {
        ...
        offset:"-=500"}).add(
    {
        targets:".scrollDown",
        translateY:["180%",0],
        offset:"-=500"})},onLeave:function()
{
    state=1;
    anime.timeline(
    {
        duration:500,easing:"easeInOutCubic"}).add(
    {
        targets:".btn-wrap",
        translateY:[0,"110%"]}).add(
    {
        targets:".back-arrow svg",
        translateX:[0,"-100%"],
        offset:"-=500"})},onLeaveCompleted:function()
{
    fullPage(),state=0;
    anime.timeline(
    {
    ...
    {
        targets:"#fp-nav ul",
        translateY:[fpnav.y,0],translateX:[fpnav.x,0],translateZ:0,
        offset:"-=500"}).add(
    {
        ...
        complete:function()
{
    resolve()}}).add(
    {
        ...
        width:[imageBig.width,
            image.width],
        height:[imageBig.height,
            image.height],
        marginRight:[0,
            image.marginRight],
